...
from evaluation_helper import compare_truth_pred
...
def HeatMapBVL(plot_x_name, plot_y_name, title,  save_name='HeatMap.png', HeatMap_dir = 'HeatMap',
    ...
    if (feature_2_name == None):
        ...
        df_aggregate = df_aggregate.groupby([feature_1_name, feature_2_name]).mean().reset_index()
        ...
        point_df_pivot.to_csv(csvname, float_format="%.5g")
        print(point_df_pivot)
        sns.heatmap(point_df_pivot, cmap = "YlGnBu", annot=True, fmt='5f')
