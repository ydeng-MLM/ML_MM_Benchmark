...
def evaluate_inverse_from_model(model_dir,  eval_data_all=False, save_misc=False, MSE_Simulator=False, save_Simulator_Ypred=False):
    ...
    # Evaluation process
    print("Start eval now:")
    pred_file, truth_file = ntwk.evaluate_inverse(save_misc=save_misc, MSE_Simulator=MSE_Simulator, save_Simulator_Ypred=save_Simulator_Ypred)
